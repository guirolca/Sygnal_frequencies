...
/* Default I2C used */
#ifndef MPU6050_I2C
#define	MPU6050_I2C                    I2C3              /*!< Default I2C */
 ...
 */
typedef enum {
	MPU6050_BW_260Hz = 0x00,
	MPU6050_BW_188Hz = 0x01,
	MPU6050_BW_98Hz = 0x02,
	MPU6050_BW_44Hz = 0x03,
	MPU6050_BW_21Hz = 0x04,
	MPU6050_BW_10Hz = 0x05,
	MPU6050_BW_5Hz = 0x06
} MPU6050_BW_t;
/**
 ...
 */
TM_MPU6050_Result_t TM_MPU6050_Init(TM_MPU6050_t* DataStruct, TM_MPU6050_Device_t DeviceNumber, TM_MPU6050_Accelerometer_t AccelerometerSensitivity, TM_MPU6050_Gyroscope_t GyroscopeSensitivity,MPU6050_BW_t);
