...
TM_MPU6050_Result_t TM_MPU6050_Init(TM_MPU6050_t* DataStruct, TM_MPU6050_Device_t DeviceNumber, TM_MPU6050_Accelerometer_t AccelerometerSensitivity, TM_MPU6050_Gyroscope_t GyroscopeSensitivity,MPU6050_BW_t BandWidth) {
	uint8_t temp;
	...
	temp = TM_I2C_Read(MPU6050_I2C, DataStruct->Address, MPU6050_CONFIG,&temp);
	temp = (temp & 0xF8) | (uint8_t)BandWidth;
	TM_I2C_Write(MPU6050_I2C, DataStruct->Address, MPU6050_CONFIG, temp);
	/* Return OK */
